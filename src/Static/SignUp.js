  ...
  return (
    <div>
      <div><Navbar />
        ...
        <TaskBar /></div>
      <div className="flex justify-content-around w-1024px m-auto ">
            ...
            <div className="card">
              ...
              <form onSubmit={formik.handleSubmit} className="p-fluid">
                ...
                <div className="field">
                  ...
                  {getFormErrorMessage("Confirm Password")}
                </div>
                <div className="field">
                  <span className="p-float-label">
                    <Calendar
                ...
                <Button
                  type="submit"
                  label="Submit"
                  className="p-button-raised p-button-secondary p-button-text mt-2"
                />
              </form>
            </div>
          </div>
